...
public class Blot {
	...
	public Blot(double minX, double minY, double maxX, double maxY, int xn, int yn, File colorsFile) {
		this.minX = minX;
		this.minY = minY;
		this.maxX = maxX;
		this.maxY = maxY;
	...
	public static void main(String[] args) {
		Blot hm = new Blot(0, 0, 100, 100, 100, 100, new File("c:/kepler/data/heatmap/colors.png"));
		hm.add(1, 1);
		hm.add(5, 5);
		hm.add(5, 5);
		hm.add(6, 7);
