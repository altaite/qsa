...
public class BiwordGenerator {
	...
	public BiwordGenerator(File home) {
	...
	private void createBiwordBag() {
		...
		// TODO make biwords more contextual, vague description of neighborhood, big clusters of words
	...
	public static void main(String[] args) {
		BiwordGenerator m = new BiwordGenerator(new File("d:/t/data/qsa/experiments/redundancy"));
		m.run();
	}
